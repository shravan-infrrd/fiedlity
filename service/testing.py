...
def extract_tables(image_path: str):
		...
		drawn = cv.drawContours(np.copy(orig), large_contours, -1, [255,0,0], 5)
		write_image('drawn.jpg', drawn)
		
		#cv.imwrite("/Users/shravanc/Desktop/drawn.jpg", drawn))
...
image_path = "/Users/shravanc/Desktop/CPA_files/pending_files/pending_dup/image/3.jpg"
